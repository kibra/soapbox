  ...
  if (mygetrequest.status==200 || window.location.href.indexOf("http")==-1){
   ...
   for (var i=0; i<jsondata.length; i++){
   	...
   	output+=shortstring;
    	...
    	output+='<\/div><div class="saveBox"><a onclick="markBoxed(\''+idnumber+'\');loadInbox(1);"><img src="/static/imgs/savebutton.png"><\/a><\/div><div class="spamButton"><a onclick="markSpam(\''+idnumber+'\');loadInbox(1);"><img src="/static/imgs/spambutton.png"><\/a><\/div><\/div>';
   }
   output+='<\/div>';
 ...
 if (mygetrequest.readyState==4){
  if (mygetrequest.status==200 || window.location.href.indexOf("http")==-1){
   ...
   for (var i=0; i<jsondata.length; i++){
   	...
   	output+=shortstring;
    	output+='...<\/div><div id="tags_and_replies"><\/div>';
    	output+='<\/div><div class="saveBox"><a onclick="markBoxed(\''+idnumber+'\');loadSent(1);"><img src="/static/imgs/savebutton.png"><\/a><\/div><div class="spamButton"><a onclick="markSpam(\''+idnumber+'\');loadSent(1);"><img src="/static/imgs/spambutton.png"><\/a><\/div><\/div>';
   }
   output+='<\/div>';
	if (page > 1) {
 ...
 if (mygetrequest.readyState==4){
  if (mygetrequest.status==200 || window.location.href.indexOf("http")==-1){
   ...
   for (var i=0; i<jsondata.length; i++){
   	...
   	output+=shortstring;
    	output+='...<\/div><div id="tags_and_replies"><\/div>';
    	output+='<\/div><div class="saveBox"><a onclick="unBoxed(\''+idnumber+'\');loadSaved(1);"><img src="/static/imgs/savebutton.png"><\/a><\/div><div class="spamButton"><a onclick="markSpam(\''+idnumber+'\');loadSaved(1);"><img src="/static/imgs/spambutton.png"><\/a><\/div><\/div>';
   }
   output+='<\/div>';
	if (page > 1) {
...
<div id="header">
	...
	<div id="loginbar" style="float:right;">
		<div id="login">
		<a onclick="loadSettings();" style="cursor:pointer;">My Account</a> | <a href="/box/logout" style="cursor:pointer;">Sign Out</a> | <a onclick="loadAbout();" style="cursor:pointer;">FAQ</a>
		</div><!-- #login -->
